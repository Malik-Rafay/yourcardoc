...
export const LIBRARY: LibraryArticle[] = [
  {
    ...
    description:
      "Brake pads wear down with use. When the friction material is thin, braking distance increases and you'll hear a squeal from the wear indicator.",
    symptoms: [
  ...
  },
  {
    ...
    description:
      "A 12V battery typically lasts 3–5 years. Cold weather, parasitic drain, or a failing alternator can shorten its life.",
    symptoms: [
      "Slow cranking",
      "Dim headlights",
  ...
  },
  {
    ...
    description:
      "Causes range from low coolant and a stuck thermostat to a failing water pump or blown head gasket. Stop driving immediately to avoid catastrophic damage.",
    symptoms: [
  ...
  },
  {
    ...
    description:
      "Most often a low refrigerant charge from a slow leak, but can also be a failing compressor or blend door actuator.",
  ...
  },
  {
    ...
    description:
      "Tires lose ~1 PSI per month and more in cold weather. Persistent loss = slow leak from a nail, valve, or rim corrosion.",
    symptoms: [
      "TPMS warning light",
  ...
  },
  {
    ...
    description:
      "Engine oil lubricates and cools moving parts. Skipping changes accelerates wear; running low can destroy bearings.",
    symptoms: [
      "Oil pressure warning light",
      "Ticking from top of engine",
      "Burning oil smell",
      "Dipstick reads below MIN",
    ],
  ...
  },
  {
    ...
    description:
      "An automatic that revs without accelerating, shifts hard, or hesitates may be low on fluid, have a worn clutch pack, or need a solenoid replaced.",
    symptoms: [
  ...
  },
  {
    ...
    description:
      "A general warning triggered by the OBD-II system. The actual problem could be anything from a loose gas cap to a failed catalytic converter.",
  ...
  },
  {
    ...
    description:
      "Distinguish between no crank (electrical) and cranks-but-won't-fire (fuel/spark). Most no-starts are battery- or starter-related.",
    symptoms: [
      "Nothing happens when key turned",
      "Clicking sound",
